  ...
  return (
    <div className="App">
      ...
      <h3 className='simulation-header'> {simulationType}  </h3>
        <Table
            type={"Evaluation"}
            tableData={[{throughPut: throughPutVal, storageUtil: storageUtilization, partitionsNotUsed: notUsed + "%", partitionsHeavilyUsed: heavilyUsed + "%", waitingQueue: queueTime, waitingInQueue: avgWaitingTime, fragmentation: internalFragementation}]}
